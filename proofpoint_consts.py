...
TYPE_ERROR_MESSAGE = "Error occurred while connecting to the Proofpoint TAP Server. Please check the asset configuration and|or action parameters."
...
PY_2TO3_ERR_MESSAGE = "Error occurred while handling python 2to3 compatibility for the input string"
